...
string g_sgw_s11_ip_addr = "10.0.0.14";
string g_sgw_s1_ip_addr = "10.0.0.14";
string g_sgw_s5_ip_addr = "10.0.0.14";
string g_pgw_s5_ip_addr = "10.0.0.13";
...
void Mme::handle_create_session_guti(int conn_fd, uint64_t guti, UdpClient &sgw_client) {
	vector<uint64_t> tai_list;
